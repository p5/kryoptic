...
// ============================================================================
// Core Entropy Source Abstraction (PR 1)
// ============================================================================
...
// ============================================================================
// Jitterentropy Support (PR 2) - requires "jitterentropy" feature
// ============================================================================
...
///     println!("Jitterentropy v{} is available", caps.jitterentropy_version.unwrap());
/// }
/// ```
...
// ============================================================================
// Core Tests (PR 1) - no jitterentropy dependency
// ============================================================================
...
// ============================================================================
// Jitterentropy Tests (PR 2) - requires "jitterentropy" feature
// ============================================================================
...
// ============================================================================
// Non-jitterentropy test for query_capabilities
// ============================================================================

#[cfg(all(test, not(feature = "jitterentropy")))]
mod non_jitterentropy_tests {
    use super::*;

    #[test]
    fn test_query_capabilities_without_jitterentropy() {
        let caps = query_capabilities();
        assert!(caps.getrandom_available);
    }
}
